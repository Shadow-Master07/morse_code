...
# 74 "src/cliArgs.c"
                         ;
        while ((token = readToken(inputFile)) != 
# 75 "src/cliArgs.c" 3
                                                ((void *)0)
# 75 "src/cliArgs.c"
                                                    )
...
# 199 "src/cliArgs.c" 3
               (__acrt_iob_func(2))
# 199 "src/cliArgs.c"
                     , "Usage: %s --mode ctf|real [--morse \"<morse_string>\" | --file <filename>]\n", argv[0]);
        exit(4);
    }
